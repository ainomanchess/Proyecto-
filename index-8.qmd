---
title: "Presencia de mamiferos en regiones socioeconomicas de Costa Rica"
...
# Función reactiva para filtrar los registros de presencia de mamiferos unidos con regiones
  ...
  mapa <- leaflet() |>
    ...
    addCircleMarkers(
      ...
      popup = paste(
        ...
        "<a href='", mamiferos$occurrenceID, "'>Más información</a>"
      ),
      group = "Mamiferos"
    ) %>%
    addLegend(
...
output$mapa <- renderPlotly({
  ...
  mapa <- riqueza_mamiferos_regiones_registros |>
    ...
    coord_flip() +
    ggtitle("Registros de presencia de mamiferos en regiones socioeconomicas") +
    xlab("Registros") +
    ylab("Regiones Socioeconomicas") +
    labs(caption = "Fuente: Ministerio de Planificación (MIDEPLAN)") +
    theme_bw()
